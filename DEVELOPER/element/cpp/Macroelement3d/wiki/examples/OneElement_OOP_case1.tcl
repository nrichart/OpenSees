# EXAMPLE 2a: One element subjected to out-of-plane loading
#
# @file   OneElement_OOP_case1.tcl
#
...
# monotonic loading, including P-Delta effects. The wall is loaded with a constant vertical load 
# and an horizontal concentrated at the top. Results can be compared to a the lateral load multiplier 
...
set initialDispl [expr 0.95*$t/2.]
set incr 0.1e-3;   
